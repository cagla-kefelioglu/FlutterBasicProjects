...
class RedOnay extends ConsumerStatefulWidget {
 

  @override
 ConsumerState<ConsumerStatefulWidget> createState() => _RedOnayState();
}

class _RedOnayState extends ConsumerState<RedOnay> {
  @override
            ...
            child: Column(children: [
              Expanded(
                ...
                child: Column(
                  ...
                  Card(
                    elevation: 0,
                    child: Image.asset("assets/images/no-stopping.png" , height: height*0.13,width: width*0.35,),
                  )
                 ],
                ),
              ),
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [Text("Randevu iptal edildi" , style: _infoText,)],),
                    ),
                  ],
                ),
              ),

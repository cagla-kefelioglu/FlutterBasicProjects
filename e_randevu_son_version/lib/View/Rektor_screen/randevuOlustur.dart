...
class randevuOlustur extends ConsumerStatefulWidget {
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _randevuOlusturState();
}

class _randevuOlusturState extends ConsumerState<randevuOlustur> {
  var datee;
  var dateTwo;
  String deneme;

...
class guncellenenRandevular extends ConsumerStatefulWidget {
  
  
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _guncellenenRandevularState();
}

class _guncellenenRandevularState extends ConsumerState<guncellenenRandevular> {
                  ...
                  children: [
                    SizedBox(
                           ...
                           child: Column(
                             mainAxisAlignment: MainAxisAlignment.start,
                             children: [
                               Tab_bar(title: "GÜNCELLENEN RANDEVULAR"),
                                 ...
                                 children: [
                                   Container(
                                     ...
                                     CupertinoSlidingSegmentedControl<int>(
                                       ...
                                       children: {
                                         0: buildSegment("Ertelenen Randevular" , width,height),
                                         1: buildSegment("Reddedilen Randevular", width,height),
                                       },
                                     ),
                                   )
                                 ],
 ...
 FutureBuilder randevu_list_Two() {
  /* İptel edilenler 3 statü*/
    return FutureBuilder(
      future: ReturnAllCanceledAppointments(),
      builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
        if (snapshot.hasData) {
          return ListView.separated(
            shrinkWrap: true,
